...
let arrayData = [
    ...
    {
        info: { img: principalGame, title: "Edição PS4", liArray: ["God of War Ragnarök PS4 e PS5", "Armadura do Valescuro", "Traje do Valescuro (cosmético)", "Punho de Machado do Valescuro", "Cabos das Lâminas do Valescuro", "Livro de arte digital da Dark Horse", "Trilha sonora digital   oficial", "Avatares da PSN para PS4 e PS5"], price: "R$399,90", key: "2" },
    },
]
