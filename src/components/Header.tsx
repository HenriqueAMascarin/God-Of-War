...
export default function Header() {
    ...
    let [headerActive, changeActive] = useState(false); //esse boolean seria o tipo do headerActive
    let [stateData, changeState] = useState<any>()



    useEffect(() =>{
        headerScroll();
        changeArray({state: changeState})
    }, []);
