import gameplay from "../../assets/images/gameplay.webp";
        ...
        <section id="buySection" >
            ...
            <div className="buySectionDiv">
                ...
                <div className="buttons">
                    <button className="changeBtn" aria-label='botão para a esquerda'>
                    ...
                    <button className="changeBtn" aria-label='botão para a direita'>
